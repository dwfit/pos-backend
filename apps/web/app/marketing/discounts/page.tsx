...
export default function DiscountsPage() {
  ...
  const [filterQualification, setFilterQualification] =
    useState<DiscountQualification | 'ALL'>('ALL');
  ...
  return (
    <div className="flex min-h-screen flex-col gap-6">
      ...
      <div className="flex flex-1 flex-col rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        {/* Pagination footer pinned to bottom of card/page */}
      ...
      {showCreate && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
            ...
            <form onSubmit={handleCreate} className="space-y-3 px-4 py-4 text-xs">
              {/* Name */}
